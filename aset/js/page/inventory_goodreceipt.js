...
var c_control 		= "inventory_goodreceipt/";
...
function add_new_row(data){
    ...
    item = '<tr class="rowid_'+id_row+' rowdata" data-row="'+id_row+'" data-classnya="rowid_'+id_row+'" data-typenya="1" data-serial="active">\
                <td>\
...
function view(id,page){
    ...
    url = host + "inventory-receipt-view/"+id+"?page=print";
...
function view_print_data(id,page){
    ...
    url = host + "inventory-receipt-view/"+id+"?page="+page;
    $(".btn-serial-v").show();
