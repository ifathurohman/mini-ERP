...
var table;
var url_list 	= host + "Jurnal_manual/ajax_list/";
var url_edit 	= host + "Jurnal_manual/ajax_edit/";
var url_hapus 	= host + "Jurnal_manual/ajax_delete/";
var url_simpan 	= host + "Jurnal_manual/save";
var url_update 	= host + "Jurnal_manual/ajax_update";
...
function add_new_row(v){
    ...
    item = 
        '<tr class="dt'+id_row+'" data-level="4" data-select="active">\
            ...
            <td>\
                <input type="text" class="readonly pointer" onclick="coa_modal('+"'.dt"+id_row+"'"+')" name="coacode[]" value="'+coacode+'" placeholder="select COA">\
            ...
            <td><input type="text" class="duit" onkeyup="SumTotal()" name="detdebit[]" placeholder="input nominal" value="'+detdebit+'"></td>\
            <td><input type="text" class="duit" onkeyup="SumTotal()" name="detcredit[]" placeholder="input nominal" value="'+detcredit+'"></td>\
            <td>'+btn_remove+'</td>\
        </tr>';
...
function view(id,page){
    ...
    url = host + "jurnal-manual-view/"+id+"?page="+page;
    ...
    url = host + "jurnal-manual-view/"+id+"?page=print";
