...
var url_list 		= host + "payment_ar/ajax_list/";
var url_edit        = host + "payment_ar/ajax_edit/";
var url_cancel 		= host + "payment_ar/cancel/";
var url_simpan 		= host + "payment_ar/save";
var url_simpan_remark = host + "payment_ar/save_remark";
...
function coa_bayar1(TipeBayar,data){
    ...
    item = '<option value="none">'+language_app.lb_coa_select+'</option>';
...
function view(id,page){
    ...
    url = host + "payment-receivable-view/"+id+"?page=print";
...
function view_print_data(id,page){
    ...
    url = host + "payment-receivable-view/"+id+"?page="+page;
...
function get_detail_invoice(id){
    url = host + "invoice_ar/ajax_edit/"+id;
    data_post = {
        page : "payment_selling",
    }
    $.ajax({
        url : url,
        data : data_post,
