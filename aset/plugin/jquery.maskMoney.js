    ...
    var methods = {
        ...
        init : function(settings) {
            ...
            return this.each(function() {
                ...
                function mask(){
                    var value = input.val();
                    var f_value = String(value).split('.');
                    if(f_value[1]){
                        var f_value_length = f_value[1].length;
                        if(f_value_length < settings.precision){
                            var f_kurangnya = settings.precision - f_value_length;
                            var f_val_decimal = '';
                            for (var i = 0; i < f_kurangnya ; i++) {
                                f_val_decimal = f_val_decimal + '0';
                            }
                            value = value + f_val_decimal;
                        }
                        value = removeduit(value);
                ...
                input.bind("click.maskMoney", mask);
                input.bind("dblclick.maskMoney", mask);
