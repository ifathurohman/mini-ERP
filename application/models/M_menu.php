...
class M_menu extends CI_Model {
	...
	private function _get_datatables_query()
	{
		...
		$this->db->select("id_menu,url,root,kategori,nama_menu,modul,modul2,ifnull(menu.index,'') as index2");
	...
	{
		$this->db->select("id_menu,url,root,kategori,nama_menu,app,modul,modul2,type");	
		$this->db->from($this->table);
