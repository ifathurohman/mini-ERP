<div class="page page-data ck-module-expire" data-module="ar" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-date="<?= date("Y-m-d") ?>" data-sellno="<?= $SellNo ?>" data-dstatus="<?= $DStatus ?>" data-hakakses="<?= $this->session->hak_akses ?>" data-title="<?= $title ?>" data-product_branch="active" data-product_branch_reset="active">
...
<?php //$this->load->view("modal/modal_add_serial2"); ?>
...
<script src="<?= base_url('aset/js/page/delivery.js'.$this->main->js_css_version()); ?>"></script>
