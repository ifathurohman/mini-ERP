<div class="page page-data" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-title="<?= $title ?>" data-status="<?= $Status ?>">
      ...
      <div class="panel-body">
          ...
          <div class="col-lg-12">
            ...
            <div class="btn-group mb-10">
              ...
              <?= $this->main->general_button('export',site_url('sales/export/')); ?>
...
<?php $this->load->view('sales/modal_import'); ?>
...
<script src="<?= base_url('aset/js/page/sales.js'.$this->main->js_css_version()); ?>"></script>