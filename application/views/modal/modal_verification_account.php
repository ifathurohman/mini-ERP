      ...
      <div class="modal-body">
        <div class="div-btn-verification">
          <div class="btn-group btn-block">
            <a href="javascript:;" onclick="send_verification_code(this)" data-id="<?= $a->id_user; ?>" data-modul="email" class="btn btn-primary width-80" style="text-align: left;"><?= $this->lang->line('lb_send_to_email') ?> : <span class="text-email"><?= $a->Email; ?></span></a>
            <a href="javascript:;" class="btn btn-default width-20" onclick="change_verification(this)" data-id="<?= $a->id_user; ?>" data-modul="email"><?= $this->lang->line('lb_change') ?></a>
          </div>
          <div class="btn-group btn-block">
            <a href="javascript:;" onclick="send_verification_code(this)" data-id="<?= $a->id_user; ?>" data-modul="phone" class="btn btn-success width-80" style="text-align: left;"><?= $this->lang->line('lb_send_to_phone') ?> : <span class="text-phone"><?= $a->PhoneNumber; ?></span></a>     
            <a href="javascript:;" class="btn btn-default width-20" onclick="change_verification(this)" data-id="<?= $a->id_user; ?>" data-modul="phone"><?= $this->lang->line('lb_change') ?></a>
          </div>
        </div>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="btn-group">
          <button type="button" class="btn btn-danger btn-default margin-0 kotak" data-dismiss="modal">Close</button>   
          <button type="button" class="btn btn-primary" onclick="save_change_verification(this)">Send</button>
        </div>
      </div>
    </div>
  </div>
