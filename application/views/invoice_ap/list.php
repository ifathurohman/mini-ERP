<div class="page page-data ck-module-expire" data-module="ap" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-date="<?= date("Y-m-d") ?>" data-hakakses="<?= $this->session->hak_akses ?>" data-id="<?= $ID ?>" data-statusid="<?= $Status ?>" data-title="<?= $title ?>">
...
<script src="<?= base_url('aset/js/page/invoice_ap.js'.$this->main->js_css_version()); ?>"></script>
<script src="<?= base_url('aset/js/page/vendor_modal.js'.$this->main->js_css_version()); ?>"></script>
<!-- <script src="<?= base_url('aset/js/page/purchase_modal.js'); ?>"></script> -->
