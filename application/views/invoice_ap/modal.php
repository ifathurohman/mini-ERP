    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form" autocomplete="off">
          ...
          <div class="row">
            <div class="form-group col-sm-2 content hidden">
              <div class="radio-custom radio-primary">
                <input type="radio" id="OrderType1" name="OrderType" type="hidden" value="1" checked>
                <label for="OrderType1">Receive</label>
              </div>
            </div>
            <!-- <div class="form-group col-sm-2">
              <div class="radio-custom radio-primary">
                <input type="radio" id="OrderType2" name="OrderType" value="2">
                <label for="OrderType2">Purchase Order</label>
              </div>
            </div> -->
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="form-group col-sm-6">
              ...
              <div class="input-group">
                ...
                <input name="CustomerName" id="CustomerName" type="text" class="form-control pointer readonly autocomplete_vendor-name" data-position="vendor" data-page="invoice" readonly="readonly" placeholder="Select Vendor" onclick="vendor_modal('.autocomplete_vendor')">
                <input name="CustomerID" id="CustomerID" type="text" placeholder="select vendor" class="form-control pointer readonly autocomplete_vendor content-hide" data-position="vendor" data-page="invoice" onclick="vendor_modal('.autocomplete_vendor')">
                <span></span>
                <!-- <span class="help-block"></span> -->
              </div>
            </div>
            ...
            <div class="form-group col-sm-6 vinvoice">
              ...
              <div class="input-group">
                ...
                <textarea name="invAddress" id="invAddress" type="text" placeholder="Select Vendor Address" class="form-control address autocomplete_vendor-address" style="height: 35px"></textarea>
              </div>
            </div>
          </div>
          ...
          <div class="row vinvoice">
            <div class="form-group col-sm-6">
              <label class="control-label"><?= $this->lang->line('lb_npwp') ?> <!-- <span class="wajib"></span> --></label>
              <input name="NPWP" id="NPWP" type="text" class="form-control autocomplete_vendor-npwp">
              <span class="help-block"></span>
            </div>
            <div class="form-group col-sm-6 vnonorder">
              ...
              <table class="table-add-product table table-striped input-table3" style="margin-top: 15px;margin-bottom: 0px;">
                <thead>
                  <tr>
                    ...
                    <th class="th-code"><?= $this->lang->line('lb_purchaseno') ?></th>
          ...
          <div class="col-sm-6">
            <div class="row">
              <div class="form-group col-sm-12">
                ...
                <textarea name="Remark" id="Remark" class="form-control txtRemark" style="height: 100px"></textarea>
                <span class="help-block"></span>
              </div>
