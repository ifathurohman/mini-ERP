<div class="page page-data ck-module-expire" data-module="ar" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-date="<?= date("Y-m-d") ?>" data-hakases="<?= $this->session->hak_akses ?>" data-id="<?= $ID ?>" data-statusid="<?= $Status ?>" data-title="<?= $title ?>">
...
<script src="<?= base_url('aset/js/page/payment_ar.js'.$this->main->js_css_version()); ?>"></script>
