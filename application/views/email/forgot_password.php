               ...
               <table class="es-left" cellspacing="0" cellpadding="0" align="left" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;float:left;"> 
                 <tbody><tr style="border-collapse:collapse;"> 
                  <td class="es-m-p20b" width="700" align="left" style="padding:0;Margin:0;"> 
                    <p>Kami telah menerima permintaan untuk mereset kata sandi Anda. Jika Anda tidak mengajukan permintaan, abaikan saja email ini. Jika tidak,   Anda dapat mengatur ulang kata sandi menggunakan tautan di bawah ini. 
                      <br> <a href="<?= $message ?>">Klik Disini</a> untuk mengubah kata sandi.
                    </p>
                    <hr>
                    <p>We've received a request to reset your password. If you didn't make the request, just ignore this email. Otherwise, you can reset your password using this link below.
                      <br> <a href="<?= $message ?>">Click Here</a> to change your password.</p>
                  </td> 
