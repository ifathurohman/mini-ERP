<div class="page page-data" data-hakakses="<?= $this->session->hak_akses; ?>" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-title="<?= $title ?>">
...
<?php $this->load->view("category/modal_import"); ?>
...
<!-- Plugins For This Page -->
<script src="<?= base_url('aset/js/page/category.js'.$this->main->js_css_version()); ?>"></script>
