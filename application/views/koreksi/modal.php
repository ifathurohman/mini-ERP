<!-- Modal -->
<div id="modal" class="modal modal-primary fade modal-fade-in-scale-up" data-backdrop="static" aria-hidden="true" aria-labelledby="exampleModalTitle" role="dialog" style="padding-top: 20px;">
  <div class="modal-dialog width-70per">
        ...
        <form id="form" autocomplete="off">
          ...
          <div class="row">
            ...
            <div class="form-group col-sm-12">
              <table class="table-add-product table table-bordered table-striped table-td-padding-0 input-table" style="margin-top: 15px;margin-bottom: 0px;">
                <thead>
                  <tr> 
                    <th colspan="2"></th>
                    ...
                    <th colspan="2"><?= $this->lang->line('lb_qty_real') ?></th>
                  </tr>
                </thead>
                <tbody>
                </tbody>
