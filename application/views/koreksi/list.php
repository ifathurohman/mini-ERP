<div class="page page-data ck-module-expire" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-module="inventory" data-hakakses="<?= $this->session->hak_akses; ?>" data-title="<?= $title ?>" data-product_branch="active" data-product_branch_reset="active">
...
<script src="<?= base_url('aset/js/page/koreksi.js'.$this->main->js_css_version()); ?>"></script>
