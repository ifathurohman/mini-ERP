<div class="page page-data ck-module-expire" data-module="ap" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-date="<?= date("Y-m-d") ?>" data-hakakses="<?= $this->session->hak_akses; ?>" data-app="pipesys" data-title="<?= $title ?>">
          ...
          <div class="col-lg-12">
            <form id="form-filter" autocomplete="off" method="post">
              <div class="row">
                ...
                <div class="col-sm-12 mb-20 mt-10">
                  <?= $tambah; ?>
...
<script src="<?= base_url('aset/js/page/purchase_order.js'.$this->main->js_css_version()); ?>"></script>
...
<script src="<?= base_url('aset/js/page/warehouse_modal.js'.$this->main->js_css_version()); ?>"></script>
