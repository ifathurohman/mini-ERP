            ...
            <div class="row">
              ...
              <div class="form-group col-sm-12">
                ...
                <div class="input-group">
                  ...
                  <input name="CustomerName" id="CustomerName" type="text" class="form-control pointer readonly autocomplete_vendor-name" data-position="vendor" readonly="readonly" placeholder="<?= $this->lang->line('lb_vendor_select') ?>" onclick="vendor_modal('.autocomplete_vendor')">
                  <input name="CustomerID" id="CustomerID" type="text" placeholder="<?= $this->lang->line('lb_vendor_select') ?>" class="form-control pointer readonly autocomplete_vendor content-hide" data-position="vendor" onclick="vendor_modal('.autocomplete_vendor')">
                  <span></span>
                </div>
              </div>
            </div>
