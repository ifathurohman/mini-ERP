      ...
      <div class="modal-body">
        <form id="form" autocomplete="off">
          	...
          	<div class="row vdelivery">
	            <div class="form-group col-sm-3 conten hidden">
	              	<div class="radio-custom radio-primary">
	                	<input type="radio" id="ckOrder3" name="ckOrder" value="3" checked>
	                	<label for="ckOrder3">Purchase</label>
	              	</div>
	            </div>
          	</div>
          	<div class="row">
	        ...
	        <div class="row">
	       	...
	       	<div class="row">
	            <div class="form-group col-sm-12 vstore content hide">
	              <table class="table-apcorrection table table-striped table-td-padding-0 input-table" style="margin-top: 15px;margin-bottom: 0px;">
	                <thead>
	                  <tr> 
	                    <th colspan="3"><?= $this->lang->line('lb_store_name') ?></th>
	                    <th><?= $this->lang->line('lb_correction_total_ap') ?></th>
	              ...
	              <a href="javascript:void(0)" onclick="add_new_row_store()" class="link_add_row">+ <?= $this->lang->line('lb_add_column') ?></a>
	            </div>

	            <div class="form-group col-sm-12 vselling">
	              <table class="table-apcorrection2 table table-striped table-td-padding-0 input-table2" style="margin-top: 15px;margin-bottom: 0px;">
	                <thead>
	                  <tr> 
	                    <th colspan="3"><?= $this->lang->line('lb_vendor_name') ?></th>
	                    <th><?= $this->lang->line('lb_correction_total_ap') ?></th>
	                    <th colspan="2"><?= $this->lang->line('lb_remark') ?></th>
	                  </tr>
	                </thead>
