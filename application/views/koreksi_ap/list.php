<div class="page page-data ck-module-expire" data-module="ap" data-hakakses="<?= $this->session->hak_akses; ?>" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-title="<?= $title ?>">
...
<script src="<?= base_url('aset/js/page/koreksi_ap.js'.$this->main->js_css_version()); ?>"></script>
<script src="<?= base_url('aset/js/page/vendor_modal.js'.$this->main->js_css_version()); ?>"></script>
<!-- <script src="<?= base_url('aset/js/page/branch_modal.js'); ?>"></script> -->
