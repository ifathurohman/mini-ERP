<div class="page page-data ck-module-expire" data-module="inventory" data-hakakses="<?= $this->session->hak_akses; ?>" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-date="<?= date("Y-m-d") ?>" data-title="<?= $title ?>" data-product_branch="active" data-product_branch_reset="active">
          ...
          <div class="col-lg-12">
            <form id="form-filter" autocomplete="off" method="post">
              <div class="row">
                ...
                <div class="form-group col-sm-3 content-hide">
...
<script src="<?= base_url('aset/js/page/inventory_goodreceipt.js'.$this->main->js_css_version()) ?>"></script>
