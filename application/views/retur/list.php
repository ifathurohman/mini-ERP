<div class="page page-data ck-module-expire" data-module="ap" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-date="<?= date("Y-m-d") ?>" data-hakases="<?= $this->session->hak_akses ?>" data-title="<?= $title ?>" data-product_branch="active" data-product_branch_reset="active">
...
<script src="<?= base_url('aset/js/page/retur.js'.$this->main->js_css_version()); ?>"></script>
...
<script src="<?= base_url('aset/js/page/rreceive_modal.js'.$this->main->js_css_version()); ?>"></script>
