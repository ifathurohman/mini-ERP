<div class="page page-data ck-module-expire" data-module="ar" data-modul="<?= $modul ?>" data-url_modul="<?= $url_modul ?>" data-date="<?= date("Y-m-d") ?>" data-hakases="<?= $this->session->hak_akses ?>" data-title="<?= $title ?>">
        ...
        <table id="table" class="table table-hover dataTable table-striped width-full" data-plugin="dataTable" cellspacing="0" width="100%">
          <thead>
             <tr>
                ...
                <th><?= $this->lang->line('lb_deliveryno') ?> / <?= $this->lang->line('lb_sellingno') ?></th>
...
<?php $this->load->view("modal/modal_delivery"); ?>
...
<script src="<?= base_url('aset/js/page/return_sales.js'.$this->main->js_css_version()); ?>"></script>
<script src="<?= base_url('aset/js/page/vendor_modal.js'.$this->main->js_css_version()); ?>"></script>
<script src="<?= base_url('aset/js/page/selling_modal.js'.$this->main->js_css_version()); ?>"></script>
<script src="<?= base_url('aset/js/page/delivery_modal.js'.$this->main->js_css_version()); ?>"></script>
