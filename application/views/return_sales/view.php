        ...
        <tr>
          <td class="w50">
            <table style="margin-bottom: 0px">
              ...
              <tr>
                <td class="td-width-150"><?= $this->lang->line('lb_return_date') ?></td><td class="td-width-10">:</td><td><?= $list->Date ?></td>
              </tr>
            </table>
          </td>
          <td class="w50">
      ...
      <table id="table" class="table table-hover dataTable table-striped width-full" data-plugin="dataTable" cellspacing="0" width="100%">
        <thead>
          <tr>
            ...
            <th><?= $this->lang->line('lb_transaction_qty') ?></th>
        ...
        <tbody>
          ...
          foreach ($detail as $k => $v) {
            ...
            $btn_serial = '';
            if($v->product_type == 2):
              $btn_serial = '<a href="javascript:;" onclick="view_serial_number('."'return_sales','".$v->ReturNo."','".$v->ReturDet."'".')" class="btn-serial-v" aria-hidden="true" style="cursor:pointer;padding:5px;">'.$this->lang->line('btn_view_serial').'</a>';
            endif;
            ...
            $item .= '<td>'.$this->main->qty($v->transactionQty).'</td>';
